...
namespace EditorEx
{
	...
	public static class SceneNameCreator
	{
		...
		private const string ITEM_NAME = "Tools/Create/Scene Define";    // コマンド名
		private const string PATH = "Assets/Scripts/System/SceneName.cs";        // ファイルパス
